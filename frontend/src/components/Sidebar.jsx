...
const Sidebar = ({ role, currentPage, setCurrentPage }) => {
    ...
    return (
      <div className="sidebar hr">
        ...
        <div className="submenu" ref={personalMenuRef} 
          ...
          <div onClick={() => handleNavigate("leave","/dashboard/hr/leave")} className="submenu-item">
            <FaCalendarAlt className="menu-icon" /> สิทธิการลา
          </div>
          <div onClick={() => handleNavigate("evaluation","/dashboard/hr/evaluation")} className="submenu-item">
            <FaChartLine className="menu-icon" /> การประเมินผล
          </div>
          <div onClick={() => handleNavigate("training","/dashboard/hr/training")} className="submenu-item">
            <FaGraduationCap className="menu-icon" /> การฝึกอบรม
          </div>
          <div onClick={() => handleNavigate("documents","/dashboard/hr/documents")} className="submenu-item">
  ...
  return (
    <div className="sidebar employee">
      <div className="sidebar-header"><h2>Employee Portal</h2></div>
