...
VALUES
('E001', 'คุณภาพงาน (Quality of Work)', 'ความถูกต้องและความละเอียดของงาน', 14),
('E001', 'ความรับผิดชอบ (Responsibility)', 'ความรับผิดชอบในหน้าที่', 15),
('E001', 'การทำงานเป็นทีม (Teamwork)', 'ความร่วมมือกับทีม', 13),
('E001', 'ความคิดสร้างสรรค์ (Creativity)', 'เสนอแนวคิดใหม่ ๆ', 14),
('E001', 'ความตรงต่อเวลา (Punctuality)', 'มาตรงเวลา ส่งงานตรงกำหนด', 15),
('E001', 'การสื่อสาร (Communication)', 'การสื่อสารกับเพื่อนร่วมงาน', 14);
